...
const ClientManagementPage = () => {
  ...
  const [newClient, setNewClient] = useState<Client>({ clientId: '', account: '', name: '', email: '', proposalName: '', limitCredit: 0 });
  ...
  const handleAddClient = async (e: FormEvent) => {
    ...
    setShowForm(false);
    setNewClient({ clientId: '', account: '', name: '', email: '', proposalName: '', limitCredit: 0 });
  };
